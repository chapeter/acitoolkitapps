...
sudo docker run -d -p 5004:5004 --name confexplorer amney/confexplorer python /opt/confexplorer/explorer.py -u http://$APIC_IP -l $APIC_USERNAME -p $APIC_PASSWORD --host 0.0.0.0 --port 5004
